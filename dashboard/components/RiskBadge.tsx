...
export function RiskBadge({ value }: { value: string }) {
  return (
    <span className={`inline-flex items-center gap-1.5 text-[11px] font-medium px-2 py-0.5 rounded-full capitalize ${STYLES[value] ?? "bg-slate-700/40 text-slate-400 border border-slate-600/30"}`}>
