...
def main():
    ...
    parser.add_argument(
        "--calib-data", default="training/data/sft.jsonl", help="JSONL file to use as AWQ calibration data"
    )
    parser.add_argument("--calib-n", type=int, default=128, help="Number of calibration samples (default: 128)")
