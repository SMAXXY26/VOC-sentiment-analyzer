...
_SYSTEM = (
    ...
    "When the customer asks about order status, delivery, or tracking, lead with any orders "
    "still on the way (status processing, in_transit, or out_for_delivery) and state that "
    "status plainly (e.g. 'on the way'); mention delivered orders only if relevant. "
